    ...
    <div class="modal-overlay" on:click|self={close}>
        ...
        >
            ...
            <div class="modal-body">
                ...
                <label class="input-label" for="edit-member-role"
                    >Role / Title</label
                >
                <input
                    id="edit-member-role"
                ...
                <div class="photo-upload-container">
                            ...
                            <div class="upload-placeholder">
                                ...
                                <p>
                                    ...
                                    <span class="upload-hint"
                                        >JPG, PNG, GIF, WebP up to 2MB</span
                                    >
                                </p>
                            </div>
                    ...
                    <div class="photo-actions">
                        ...
                        >
                            ...
                            {filePreviewUrl ||
                            (member?.photoURL && file !== "REMOVE_PHOTO")
                                ? "Change Photo"
                                : "Add Photo"}
                        </button>
                    </div>
                        ...
                        {:else if member?.cvURL && member?.cvFileName}
                            ...
                            >
                                <div class="cv-file-info">
                                    ...
                                    <div class="cv-details">
                                        ...
                                        <div class="cv-uploaded">
                                            Uploaded {member.cvUploadedAt
                                                ? new Date(
                                                      member.cvUploadedAt.toDate
                                                          ? member.cvUploadedAt.toDate()
                                                          : member.cvUploadedAt,
                                                  ).toLocaleDateString()
                                                : "Unknown"}
                                ...
                                <div class="cv-overlay">
                                    ...
                                    <span
                                        >Hover to preview • Click to change</span
                                    >
                                </div>
                            </div>
                        {:else}
